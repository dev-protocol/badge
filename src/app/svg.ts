...
<g id="Background">
	<path id="Right" class="st0" d="M87,0H37v20h50c1.7,0,3-1.3,3-3V3C90,1.3,88.7,0,87,0z"/>
...
<text transform="matrix(1 0 0 1 43.0383 13.0817)" class="st2 st3 st4">${num}</text>
